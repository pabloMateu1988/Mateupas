...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      <div class="main">
        <form action="email/enviar_reduccion.php" method="post">
            <div class="text-center" style="font-family:'Passion One'">
              <h1><a href="clientes.php">REDUCCIÓN</a></h1>
            </div>
            <div class="">
              ...
              <div class="col-md-12">
                  <p class="text-center" style="margin:50px">Solicito la reducción de cobertura de la póliza <input type="text" name="poliza" value="" placeholder="47/xxxxxx.."style="text-align:center"> a <input type="text" class="col-4" name="cobertura" value=""placeholder="Ingresar cobertura.." style="text-align:center"> correspondiente al vehículo con dominio
