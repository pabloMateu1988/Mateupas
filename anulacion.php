...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="container">
      <div class="main">
        <form action="email/enviar_anulacion.php" method="post">
            <div class="text-center" style="font-family:'Passion One'">
              <h1><a href="clientes.php">ANULACIÓN</a></h1>
            </div>
            <div class="">
              ...
              <div class="col-md-12">
                  <p class="text-center" style="margin:50px">Solicito la anulación de cobertura de la póliza <input type="text" name="poliza" value="" placeholder="47/xxxxxx.."style="text-align:center"> correspondiente al vehículo con dominio
                    <input type="text" name="patente" value="" style="text-align:center" placeholder="AA999BB/789AAA"> a partir del día <input type="text" name="fecha" value="" placeholder="Ingresar dd/mm/aaaa.."style="text-align:center"> .</p>
              </div>
              <div class="container">
                  <div class="row">
                    <div class="col-sm">
