...
if ($nombre == "" or $fecha == "" or $poliza == "" or $patente == "" or $cobertura == "" or $dni == "" or $email == "") {
        ...
        header('location:https://mateupas.com/ampliacion.php');
		    ...
		    header('location:https://mateupas.com/ampliacion.php');
							...
							$msjCorreo = "Solicito la ampliación de cobertura de la póliza número " .$poliza. " a " .$cobertura. " correspondiente al vehículo con dominio " .$patente. " a partir del día " . $fecha . " .
              ...
              $msjCorreo2.= "\r\n\n";
              $msjCorreo2.= "Solicito la ampliación de cobertura de la póliza número " .$poliza. " a " .$cobertura. " correspondiente al vehículo con dominio " .$patente. " a partir del día " . $fecha . " .
              ...
              $msjCorreo2.= "\r\n\n";
							...
							$titulo    = 'Suplemento de ampliación';
							...
							if (mail($para,$titulo,$msjCorreo, $cabeceras)) {
							     ...
							     echo "<script>alert('El formulario ha sido enviado, va a recibir un mail de confirmación. Por favor remitir que el mail de confirmación le ha llegado, muchas gracias.'); location.href='https://mateupas.com/clientes.php';</script>";
							        ...
							        echo "<script>alert('Hubo un error, volver a enviar el formulario'); location.href='https://mateupas.com/ampliacion.php';</script>";
							}
					  }
